        ...
        <img
          ...
          className={`${
            theme === "dark" || icon === "01d"
              ? " brightness-125"
              : " brightness-90"
          } object-none object-center h-28 w-36`}
        />
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center justify-evenly gap-2 w-full">
              ...
              {isDesktop ? (
                <div className="flex flex-col justify-evenly gap-1 w-full">
                  ...
                  {weatherData ? (
                    <div className="text-black/60 dark:text-white/60 flex gap-4 items-center justify-center md:justify-start">
              ...
              <div className="w-full xl:mt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                ...
                {!isDesktop ? (
                  <div className="w-full rounded-xl bg-indigo-100 shadow-lg dark:bg-slate-500 h-40 md:h-64 p-6 flex flex-col items-center justify-center gap-2">
                    ...
                    {weatherData ? (
                      <div className="text-black/60 dark:text-white/60 flex gap-3 items-center justify-center">
                        <div className="flex gap-1 items-center">
                          <MdOutlineDateRange />
                          <span>
                            {moment
                ...
                {/* weather card */}
                {weatherData ? (
                  <div className="w-full rounded-xl bg-indigo-100 shadow-lg dark:bg-slate-500 h-52 sm:h-64 p-5 flex flex-col justify-between overflow-hidden">
                    ...
                    <div className="flex items-end justify-between w-full relative">
                      ...
                      {weatherData?.weather?.length > 0 && (
                        <img
                          ...
                          alt="can't load image"
                          className={` absolute bottom-[-10px] right-[-20px] md:right-[-10px] ${
                            theme === "dark" ||
                ...
                {weatherData ? (
                  <div className="relative overflow-hidden w-full rounded-xl bg-indigo-100 shadow-lg dark:bg-slate-500 h-52 sm:h-64 p-5 flex items-center gap-10 justify-evenly">
                    <img
                      src={
                        "https://i.pinimg.com/736x/63/44/fb/6344fb46661e5886aa86f53b11d6c6cb.jpg"
                      }
                      alt=""
                      className={`w-full absolute bottom-0 left-0 z-0 opacity-70 brightness-90 dark:brightness-50`}
                    />
                    <div
                      className={`flex flex-col items-center z-10 text-black/70 dark:text-white`}
                    >
                      <FiSunrise size={60} />
                      <span className="text-2xl font-bold">{t("sunrise")}</span>
                      <span>
                        {moment
                    ...
                    >
                      <FiSunset size={60} />
                      <span className="text-2xl font-bold">{t("sunset")}</span>
                      <span>
                        {moment
                ...
                {weatherData ? (
                  <div className="w-full rounded-xl bg-indigo-100 shadow-lg dark:bg-slate-500 h-64 p-3 sm:p-5 grid grid-cols-3 content-center gap-2 text-sm">
                ...
                {/* forecast card */}
                {forecast ? (
                  <div className="w-full rounded-xl bg-indigo-100 shadow-lg dark:bg-slate-500 md:col-span-2 xl:col-span-3 p-5 ">
